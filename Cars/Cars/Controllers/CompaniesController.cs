...
namespace Cars.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        public CompaniesController(CarContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Companies
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Company>>> GetСompanies()
        {
        ...
        {
            return _context.Сompanies.Any(e => e.CompanyId == id);
        }
    }
}
